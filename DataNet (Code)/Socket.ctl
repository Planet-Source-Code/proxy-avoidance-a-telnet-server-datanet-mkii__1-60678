...
Public Event Speed(UPstream As Long, DOWNstream As Long)
...
RaiseEvent Speed(0, Len(data))
DoEvents
End Sub

Public Sub Listen(Optional Successfull As Boolean)
cmSocket.Listen Successfull
End Sub
